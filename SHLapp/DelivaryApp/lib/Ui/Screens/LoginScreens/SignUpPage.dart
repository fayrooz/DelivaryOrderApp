import 'package:delivaryapp/Ui/Screens/OrderScreens/AddOrderPage.dart';
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(  "انشاء حساب جديد" ,style: TextStyle(fontSize: 20,color: Colors.black,fontFamily: "Al-Jazeera-Arabic-Bold")),
                          SizedBox(height: 10,),
                                  ...
                                  child: TextButton (
                                    ...
                                    onPressed: ()  async {
                                      Navigator.of(context).pushReplacement(
                                          MaterialPageRoute(builder: (BuildContext context) => AddOrderPage()));
